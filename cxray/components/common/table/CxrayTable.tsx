...
export default function CxrayTable({searchItems, headers, getDatasApi, additionalCondition, handleClickRow}: 
  {searchItems: KeySelectItem[], headers: CommonTableColumn[]
  ...
  const [list, setList] = useState<CCEResult[]>([]);
